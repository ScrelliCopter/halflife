...
void CHud :: Init( void )
{
	...
	cl_viewrollangle = CVAR_CREATE ( "cl_viewrollangle", "0.36", FCVAR_CLIENTDLL | FCVAR_ARCHIVE );
	cl_viewrollspeed = CVAR_CREATE ( "cl_viewrollspeed", "200", FCVAR_CLIENTDLL | FCVAR_ARCHIVE );
